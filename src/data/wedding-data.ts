...
export const timelinePhases: TimelinePhase[] = [
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        endDate: '2026-08-01',
        subTasks: [
          { id: 'p1-t2-s1', name: '求婚时间', details: '', completed: false },
          { id: 'p1-t2-s2', name: '求婚地点', details: '', completed: false },
          { id: 'p1-t2-s3', name: '求婚布置', details: '', completed: false },
          { id: 'p1-t2-s4', name: '求婚礼物', details: '', completed: false },
          { id: 'p1-t2-s5', name: '求婚告白', details: '', completed: false },
          { id: 'p1-t2-s6', name: '摄像记录', details: '', completed: false },
        ],
      },
      {
        id: 'p1-t3',
        ...
        endDate: '2026-10-01',
        subTasks: [
          { id: 'p1-t3-s1', name: '购买钻戒', details: '钻戒一般在求婚之前就已经买了', completed: false },
